  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <form onSubmit={handleCheckout} className="space-y-4">
        ...
        <input type="phonenumber" placeholder="Phone Number" className="w-full border p-2 rounded" required />
        <input type="text" placeholder="Delivery Address" className="w-full border p-2 rounded" required />
